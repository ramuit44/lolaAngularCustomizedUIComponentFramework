describe('appname.preferences', function() {
	...
	// Load the module, which contains Preferences-layout
	...
	describe('display parameter myParam', function() {
		...
		// 	// Compile a piece of HTML containing Preferences-layout
		// 	var element = $compile('<appname-preferences-layout my-param="Hello world"></appname-preferences-layout>')($rootScope);
		//
		// 	$rootScope.$digest();
		//

describe('appname.common', function() {
	...
	// Load the module, which contains Tabs
	...
	describe('display parameter myParam', function() {
		...
		// 	// Compile a piece of HTML containing Tabs
		// 	var element = $compile('<appname-tabs my-param="Hello world"></appname-tabs>')($rootScope);
		//
		// 	$rootScope.$digest();
		//

describe('gui.ng.forms.components', function() {
	...
	// Load the module, which contains Text-input
	...
	describe('display parameter myParam', function() {
		...
		// 	// Compile a piece of HTML containing Text-input
		// 	var element = $compile('<gui-text-input my-param="Hello world"></gui-text-input>')($rootScope);
		//
		// 	$rootScope.$digest();
		//

...
describe('appname.common.address-component', function() {
	var $compile,
	$rootScope;

	// Load the module, which contains Header
	beforeEach(angular.mock.module('appname.common.address-component'));
	...
	describe('display parameter myParam', function() {
		...
		// 	var element = $compile('<appname-header my-param="Hello world"></appname-header>')($rootScope);
		//
		// 	$rootScope.$digest();
		//

describe('appname.common', function() {
	...
	// Load the module, which contains Footer
	...
	describe('display parameter myParam', function() {
		...
		// 	// Compile a piece of HTML containing Footer
		// 	var element = $compile('<appname-footer my-param="Hello world"></appname-footer>')($rootScope);
		//
		// 	$rootScope.$digest();
		//
